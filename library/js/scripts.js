...
var sticky_nav_mobile = navbar.offsetTop;
...
function stickyNav() {
  if (window.pageYOffset >= sticky_nav) {
	...
	if (window.pageYOffset >= sticky_nav_mobile) {
		mobilenav.classList.add("mobile_sticky")
  } else {
		mobilenav.classList.remove("mobile_sticky");
  }
}
